...
option(FAWKES_USE_WIN32_LEAN_AND_MEAN "If enabled, define WIN32_LEAN_AND_MEAN" ON)

if(FAWKES_NOT_SUBPROJECT)
  message(STATUS "fawkes compiler MSVC global conf is in active")
...
message(STATUS "FAWKES_USE_MSVC_PARALLEL_BUILD = ${FAWKES_USE_MSVC_PARALLEL_BUILD}")
  ...
  if(NOT TARGET_TYPE STREQUAL "INTERFACE_LIBRARY")
    target_compile_definitions(${TARGET}
      PUBLIC
        ...
        $<$<BOOL:FAWKES_USE_WIN32_LEAN_AND_MEAN>:WIN32_LEAN_AND_MEAN>
    )
